...
public class Tag {
	...
	public Tag(String tag, int postCount, int maxScore, int minScore, int avgScore, int maxAnswerCount, int minAnswerCount, int avgAnswerCount, int maxFavoriteCount, int minFavoriteCount, int avgFavoriteCount, int commentCount, int maxCommentScore, int minCommentScore, int avgCommentScore) {
		this.tag = tag;
